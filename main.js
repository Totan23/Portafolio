...
const modalData = {
  ...
  bankbot: {
    ...
    shortYear: '2025',
    shortDesc: 'Bot automatizado de Binance P2P que procesa transferencias bancarias mediante web scraping, sin uso de APIs.',
    images: [],
    platform: 'Python · Selenium · Web Scraping · CLI',
    desc: 'Herramienta de automatización para operaciones de Binance P2P en Venezuela. El sistema detecta nuevas órdenes, valida la identidad de la contraparte, ejecuta transferencias bancarias directamente en los portales de banca en línea (Mercantil, Banesco, BBVA Provincial y Bancamiga) mediante web scraping con Selenium —sin depender de APIs bancarias— y notifica automáticamente el pago al comprador. Todo el flujo se gestiona desde la terminal.',
    problem: 'Los vendedores P2P en Venezuela enfrentan pérdidas operativas debido al proceso manual: leer la orden, acceder al banco, realizar la transferencia y enviar el comprobante. Dado que los bancos locales no exponen APIs públicas, no existía una solución confiable capaz de automatizar el ciclo completo de transacción sin intervención humana.',
    highlights: [
      ...
      'Ejecución de transferencias reales vía scraping de la banca en línea —cero dependencia de APIs',
